...
Using `ClosureTableBehavior::roots()`:
...
Using `ClosureTableBehavior::descendants()`:
...
Using `ClosureTableBehavior::children()`:
...
Using `ClosureTableBehavior::ancestors()`:
...
Using `ClosureTableBehavior::parent()`:
...
Using `ClosureTableBehavior::prev()` or
...
You can create a root node using `ClosureTableBehavior::saveNode()`.
